...
namespace xBindDataExample.Models
{
    ...
    public class BookManager
    {
        public static List<Book> GetBooks()
        {
            ...
            books.Add(new Book { BookId = 2, Title = "Mazin", Author = "Sequiter One", CoverImage = "Assets/2.png" });
            ...
            books.Add(new Book { BookId = 10, Title = "Decima", Author = "Tuffy Tibblest", CoverImage = "Assets/10.png" });
